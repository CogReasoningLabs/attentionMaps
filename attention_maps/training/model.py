...
from attention_maps.training.attention import ATTENTION_REGISTRY
...
class TinyTransformerLM(nn.Module):
    ...
    def generate(
        ...
        self.eval()
        # Inference inspection only consumes the final sampling context. Keeping
        # every T×T map from every generation step can otherwise exhaust GPU RAM.
        last_step_attentions: list[torch.Tensor] | None = None
        ...
        for _ in range(max_new_tokens):
            ...
            if return_attention and out["attentions"]:
                last_step_attentions = out["attentions"]
        ...
        return {
            ...
            "last_step_attentions": (
                last_step_attentions if return_attention else None
            ),
        }
